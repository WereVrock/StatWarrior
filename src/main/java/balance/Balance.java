...
public final class Balance {
    ...
    public static float PLAYER_MUSCLE             = 100f;
    public static float PLAYER_STAMINA            = 100f;
    public static float PLAYER_STAMINA_REGEN      = 8f;
    public static float PLAYER_STAMINA_SPRINT_DRAIN = 15f;
    public static float PLAYER_SPRINT_SPEED_MULT  = 1.7f;
    // === PLAYER MELEE ===
    public static float PLAYER_MELEE_DAMAGE         = 25f;
    public static float PLAYER_MELEE_RANGE          = 48f;
    public static float PLAYER_MELEE_LUNGE_SPEED    = 12f;
    public static float PLAYER_MELEE_LUNGE_DURATION = 0.14f;
    public static float PLAYER_MELEE_RETURN_SPEED   = 8f;
    public static float PLAYER_MELEE_RETURN_DURATION= 0.18f;
    public static float PLAYER_MELEE_COOLDOWN       = 0.8f;
    public static float PLAYER_MELEE_HIT_RADIUS     = 1.4f;
    // === PLAYER DAMAGE ===
    public static float PLAYER_MUSCLE_HIT_DAMAGE  = 20f;
    public static float PLAYER_HEALTH_HIT_DAMAGE  = 15f;
    // === ENEMY ===
    ...
    // === ENEMY HEALTH ===
    public static float ENEMY_HEALTH                     = 100f;
    // === ENEMY DAMAGE ===
    public static float ENEMY_MELEE_DAMAGE               = 20f;
    public static float ENEMY_CHARGE_DAMAGE              = 30f;
    public static float ENEMY_RANGED_DAMAGE              = 15f;
    // === ATTACK SHARED ===
